function Footer() {
  return (
    <>
      <footer className="px-6 divide-y container mx-auto md:px-10">
          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            ...
            <div className="space-y-3">
              ...
              <ul className="space-y-1">
                <li>
                  <a
                    rel="noopener noreferrer"
                    href="https://www.instagram.com/nabilarisha01/"
                  >
                    Nabila Risha
                  </a>
                </li>
                ...
                <li>
                  <a
                    rel="noopener noreferrer"
                    href="https://www.instagram.com/novaadrr/"
                  >
                    Nova Chandra
                  </a>
                </li>
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-start space-x-3">
                <a
                  rel="noopener noreferrer"
                  href="https://www.facebook.com/smktelkommalang/?locale=id_ID"
                  title="Facebook"
